...
class TestRbacApi(TestCaseBase):
    ...
    def test_delete_role_for_user(self):
        ...
        self.assertCountEqual(e.get_roles_for_user("alice"), ["data2_admin"])
    ...
    def test_enforce_implicit_permissions_api(self):
        ...
        self.assertCountEqual(
            e.get_implicit_permissions_for_user("bob"), [["bob", "data2", "write"]]
        )
    ...
    def test_enforce_implicit_permissions_api_with_domain(self):
        ...
        self.assertCountEqual(e.get_implicit_permissions_for_user("bob", "domain1"), [])
    ...
    def test_implicit_user_api(self):
        ...
        self.assertEqual(
            ["alice"], e.get_implicit_users_for_permission("data1", "write")
        )
        self.assertEqual(
            ["alice"], e.get_implicit_users_for_permission("data2", "read")
        )
        self.assertEqual(
