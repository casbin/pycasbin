...
class TestBuiltinOperators(TestCase):
    ...
    def test_glob_match(self):
        ...
        self.assertTrue(util.glob_match_func("/home/users/alice", "/home/**"))
        self.assertTrue(util.glob_match_func("/home/users/alice/profile", "/home/**"))
        self.assertTrue(util.glob_match_func("/home/users", "/home/**"))
        self.assertFalse(util.glob_match_func("/other/path", "/home/**"))
        self.assertTrue(util.glob_match_func("/api/v1/users/alice/data", "/api/**/data"))
        self.assertTrue(util.glob_match_func("/api/v1/data", "/api/**/data"))
        self.assertTrue(util.glob_match_func("/api/data", "/api/**/data"))
        self.assertFalse(util.glob_match_func("/api/v1/users/alice/profile", "/api/**/data"))
        self.assertTrue(util.glob_match_func("some/path/to/resource.csv", "**/resource.csv"))
        self.assertTrue(util.glob_match_func("resource.csv", "**/resource.csv"))
        self.assertFalse(util.glob_match_func("some/path/to/another.txt", "**/resource.csv"))
        self.assertFalse(util.glob_match_func("/home/users/alice", "/home/*"))
        self.assertTrue(util.glob_match_func("/home/users", "/home/*"))
        self.assertTrue(util.glob_match_func("/home/users/alice", "/home/*/alice")) 
